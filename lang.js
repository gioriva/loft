...
function readLang() {
  try { var d = JSON.parse(window.name||'{}'); if(d.lang && SUPPORTED.indexOf(d.lang)>-1) return d.lang; } catch(e){}
  try { var s = localStorage.getItem('al_lang'); if(s && SUPPORTED.indexOf(s)>-1) return s; } catch(e){}
  return 'it';
}
function writeLang(lang) {
  try { window.name = JSON.stringify({lang:lang}); } catch(e){}
...
var T = {
  ...
  "home.hero.tag": {
  it: "Como · Viale Innocenzo XI",
  en: "Como · Viale Innocenzo XI",
  fr: "Côme · Viale Innocenzo XI",
  de: "Como · Viale Innocenzo XI"
  },
  "home.hero.sub": {
